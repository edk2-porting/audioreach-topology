...
#
#
# Device SubGraph  for Tertiary MI2S Backend
#
#         ___________________
#        |   Sub Graph 2     |
# Mixer -| [LOG] -> [I2S EP]|
...
DEVICE_SG_ADD(audioreach/subgraph-device-i2s-playback.m4, `Primary', PRIMARY_MI2S_RX,
	...
	0x00004006, 0x00004006, 0x00006060, `PRI_MI2S_RX')
dnl
dnl WCDRX Playback
...
STREAM_DEVICE_PLAYBACK_MIXER(PRIMARY_MI2S_RX, ``PRI_MI2S_RX'', ``MultiMedia1'', ``MultiMedia2'')
STREAM_DEVICE_PLAYBACK_MIXER(RX_CODEC_DMA_RX_0, ``RX_CODEC_DMA_RX_0'', ``MultiMedia1'', ``MultiMedia2'')

STREAM_DEVICE_PLAYBACK_ROUTE(PRIMARY_MI2S_RX, ``PRI_MI2S_RX Audio Mixer'', ``MultiMedia1, stream0.logger1'', ``MultiMedia2, stream1.logger1'')
